...
public class CustomETS extends android.support.v7.widget.AppCompatEditText {
 ...
 //   public CustomET(Context context) {
   //     super(context);
    ...
    public CustomETS(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public CustomETS(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
        ...
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getX() > et.getWidth() - et.getPaddingRight() - imgCloseButton.getIntrinsicWidth()) {
                    et.setText("");
                    CustomETS.this.handleClearButton();
                }
                return false;
            }
        });
